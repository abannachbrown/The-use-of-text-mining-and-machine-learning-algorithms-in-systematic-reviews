...
classifier1 <- read_csv("~/PhD/Error Analysis/Error Analysis Publication/classifier1.csv")
classifier2 <- read_csv("~/PhD/Error Analysis/Error Analysis Publication/classifier2.csv")
classifier3 <- read_csv("~/PhD/Error Analysis/Error Analysis Publication/classifier3.csv")
classifier4 <- read_csv("~/PhD/Error Analysis/Error Analysis Publication/classifier4.csv")
classifier5 <- read_csv("~/PhD/Error Analysis/Error Analysis Publication/classifier5-v2.csv")

cutoffs <- read_csv("~/PhD/Error Analysis/Error Analysis Publication/cutoffs.csv", col_names = FALSE)
cutoffs2 <- read_csv("~/PhD/Error Analysis/Error Analysis Publication/cutoffs2.csv", col_names = FALSE)
...
row.names(class2Conf) <- class2Conf$X1
...
hoverinfo='text'
  ...
  add_trace(x=~class2Conf$X2[5:285], y = ~class2Conf$X3[5:285], 
            name = 'Classifier 2', mode='lines',
            text = paste("Cut-Off Value: ", row.names(class2Conf[5:285,]), 
                         "<br>Sensitivity: ", class2Conf$X2[5:285],
                         "<br>Specificity: ", class2Conf$X3[5:285]), 
            hoverinfo='text')%>%
